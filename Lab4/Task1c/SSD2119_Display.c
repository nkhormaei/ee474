...
static void LCD_GPIOInit(void){
    ...
    GPIO_PORTK_AFSEL_R = 0x00;                    // disable alternate functions
    ...
    GPIO_PORTM_AFSEL_R = 0x00;                          // disable alternate functions
   ...
   GPIO_PORTN_AFSEL_R = 0x00;                        // disable alternate functions
   GPIO_PORTN_DEN_R  |= 0x30;                        // enable digital I/O on PN4, PN5
    ...
    GPIO_PORTP_AFSEL_R = 0x00;                       // disable alternate functions
    ...
    GPIO_PORTQ_AFSEL_R = 0x00;                         // disable alternate functions
